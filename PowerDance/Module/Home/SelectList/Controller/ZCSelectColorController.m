//
//  ZCSelectColorController.m
//  PowerDance
//
//  Created by PC-N121 on 2021/10/29.
//

#import "ZCSelectColorController.h"
#import "ZCSelectBaseCell.h"

@interface ZCSelectColorController ()<UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation ZCSelectColorController
...
- (void)viewDidLoad {
    ...
    [self getShowColorInfo];
}

- (void)configureBaseInfo {
    self.showNavStatus = YES;
    self.titleStr = NSLocalizedString(@"选择颜色", nil);
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    self.callBackBlock(model.colourCode);
    [self.navigationController popViewControllerAnimated:YES];
}

- (void)getShowColorInfo {
    [ZCTrainManage queryTrainActionHomeColorInfo:@{} completeHandler:^(id  _Nonnull responseObj) {
