...
@implementation ZCTrainTopTimeView
...
- (void)createSubviews {
    ...
    sep1View.backgroundColor = rgba(43, 42, 51, 0.2);
...
- (void)setDataArr:(NSArray *)dataArr {
    ...
    for (NSDictionary *dic in dataArr) {
        ...
        for (NSDictionary *itemDic in dic[@"actionList"]) {
