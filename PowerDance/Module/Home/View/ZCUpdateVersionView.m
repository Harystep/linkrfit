...
@implementation ZCUpdateVersionView
...
- (void)setupSubviews {
    ...
    self.alertTitle.text = NSLocalizedString(@"更新提示", nil);
    self.alertTitle.font = FONT_BOLD(15);
    ...
    self.confirmBtn.backgroundColor = [ZCConfigColor txtColor];
