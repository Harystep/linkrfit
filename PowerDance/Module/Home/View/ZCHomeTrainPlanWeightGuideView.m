//
//  ZCHomeTrainPlanWeightGuideView.m
//  PowerDance
//
...
@interface ZCHomeTrainPlanWeightGuideView ()<rulerDelegate>
...
@implementation ZCHomeTrainPlanWeightGuideView
...
- (void)createSubviews {
    ...
    UILabel *lb = [self createSimpleLabelWithTitle:NSLocalizedString(@"5、请选择你的当前体重", nil) font:14 bold:NO color:[ZCConfigColor point8TxtColor]];
    [self addSubview:lb];
...
- (void)backOperate {
    [self routerWithEventName:@"weightBack" userInfo:@{}];
}
...
- (void)btnOperate {
    ...
    [self routerWithEventName:@"weightNext" userInfo:@{@"weight":content}];
