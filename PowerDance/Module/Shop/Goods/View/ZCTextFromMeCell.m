...
@implementation ZCTextFromMeCell
...
+ (instancetype)chatMessageCellWithTableView:(UITableView *)tableView idnexPath:(NSIndexPath *)indexPath {
    ZCTextFromMeCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ZCTextFromMeCell" forIndexPath:indexPath];
    return cell;
}
