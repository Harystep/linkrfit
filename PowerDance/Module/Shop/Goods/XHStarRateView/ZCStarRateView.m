...
#define ForegroundStarImage @"good_score_sel"
#define BackgroundStarImage @"good_score_nor"

typedef void(^completeBlock)(CGFloat currentScore);

@interface ZCStarRateView()
...
- (void)layoutSubviews {
    ...
    __weak ZCStarRateView *weakSelf = self;
