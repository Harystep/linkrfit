...
//    self.webSocket = [[RMWebSocket alloc] initWithURL:[NSURL URLWithString:@"https://dev-im-gateway.runxsports.com/ws/token=88888888"]];
    //  ws://192.168.1.241:9009/websocket  wss://https://www.targetsiot.com/api
    self.webSocket = [[SRWebSocket alloc] initWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@", @"wss://www.targetsiot.com/api/websocket?token=", kUserInfo.token]]];
