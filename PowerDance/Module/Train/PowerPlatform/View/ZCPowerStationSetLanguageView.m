//
//  ZCPowerStationSetLanguageView.m
//  PowerDance
//
...
@interface ZCPowerStationSetLanguageView ()
...
@implementation ZCPowerStationSetLanguageView
...
- (void)createSubviews {
    ...
    CGFloat height = 38;
    NSArray *unitArr = @[NSLocalizedString(@"繁体中文", nil), NSLocalizedString(@"简体中文", nil), NSLocalizedString(@"英文", nil)];
    for (int i = 0; i < unitArr.count; i ++) {
        UIButton *btn = [self createSimpleButtonWithTitle:unitArr[i] font:14 color:rgba(119, 124, 128, 1)];
