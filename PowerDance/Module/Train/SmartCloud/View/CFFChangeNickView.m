...
@implementation CFFChangeNickView
...
- (void)createSubviews {
    ...
    self.descL = [self createSimpleLabelWithTitle:NSLocalizedString(@"请设置体重，为了更好的用户体验", nil) font:9 bold:NO color:[ZCConfigColor subTxtColor]];
    ...
    tf.textColor = kCFF_COLOR_CONTENT_TITLE;
