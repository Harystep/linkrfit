...
@interface ZCTrainFilterActionCategoryView ()<UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation ZCTrainFilterActionCategoryView
...
- (void)cleanBtnOperate {
    ...
    if (self.cleanFilterData) {
        self.cleanFilterData();
    }
}
...
//            ZCFilterBottomReusableView *bottomView = [collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:@"footerView" forIndexPath:indexPath];
//            return bottomView;
//        } else {
//            return view;
//        }
...
//        layout. minimumInteritemSpacing  = 20;
        ...
        //ZCFilterBottomReusableView
        [_collectionView registerClass:[ZCFilterBottomReusableView class] forSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:@"footerView"];
