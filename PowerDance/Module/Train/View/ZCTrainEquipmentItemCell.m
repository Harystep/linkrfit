//
//  ZCTrainEquipmentItemCell.m
//  PowerDance
//
//  Created by PC-N121 on 2022/4/20.
//

#import "ZCTrainEquipmentItemCell.h"
#import "ZCTrainEquipmentSimpleCell.h"

@interface ZCTrainEquipmentItemCell ()<UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation ZCTrainEquipmentItemCell
...
+ (instancetype)trainEquipmentItemCellWithTableView:(UITableView *)tableView idnexPath:(NSIndexPath *)indexPath {
    ZCTrainEquipmentItemCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ZCTrainEquipmentItemCell" forIndexPath:indexPath];
    return cell;
}
...
//    self.topView = [[UIView alloc] initWithFrame:CGRectMake(AUTO_MARGIN(20), 0, SCREEN_W - AUTO_MARGIN(40), AUTO_MARGIN(201))];
    self.topView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_W, AUTO_MARGIN(180))];
...
//    [self setupViewColors:self.topView frame:CGRectMake(0, 0, SCREEN_W - AUTO_MARGIN(40), AUTO_MARGIN(201))];
    ...
    UILabel *lb = [self createSimpleLabelWithTitle:NSLocalizedString(@"器械练习", nil) font:AUTO_MARGIN(15) bold:YES color:[ZCConfigColor txtColor]];
...
//        make.bottom.mas_equalTo(self.contentView.mas_bottom);
        make.height.mas_equalTo(AUTO_MARGIN(176));
    }];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ZCTrainEquipmentSimpleCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"ZCTrainEquipmentSimpleCell" forIndexPath:indexPath];
...
- (void)moreOperate {
    [HCRouter router:@"TrainEquipment" params:@{} viewController:self.superViewController animated:YES];
}
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[ZCTrainEquipmentSimpleCell class] forCellWithReuseIdentifier:@"ZCTrainEquipmentSimpleCell"];
    }
