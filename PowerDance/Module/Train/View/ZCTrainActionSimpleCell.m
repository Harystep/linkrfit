...
@interface ZCTrainActionSimpleCell () <UICollectionViewDataSource, UICollectionViewDelegate>
...
@implementation ZCTrainActionSimpleCell
...
+ (instancetype)trainActionCellWithTableView:(UITableView *)tableView idnexPath:(NSIndexPath *)indexPath {
    ZCTrainActionSimpleCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ZCTrainActionSimpleCell" forIndexPath:indexPath];
    return cell;
}
...
//    self.topView = [[UIView alloc] initWithFrame:CGRectMake(AUTO_MARGIN(20), 0, SCREEN_W - AUTO_MARGIN(40), AUTO_MARGIN(201))];
    self.topView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_W, AUTO_MARGIN(201))];
