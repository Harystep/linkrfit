...
- (void)setUrlString:(NSString *)urlString {
    ...
    if ([urlString containsString:@"http"]) {
        ...
        _asset = [AVURLAsset URLAssetWithURL:[NSURL fileURLWithPath:urlString isDirectory:YES] options:nil];
    }
}
...
- (void)moviePlayDidEnd:(NSNotification *)noti {
    NSLog(@"播放完成");
    [[NSNotificationCenter defaultCenter] postNotificationName:kPlayVideoFinishKey object:nil];
}
