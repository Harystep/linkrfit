...
- (void)viewDidLoad {
	...
	self.player = [[JRPlayerView alloc] initWithFrame:CGRectMake(0, 20, SCREEN_W, AUTO_MARGIN(180))
												asset:[NSURL URLWithString:@"https://static.ouj.com/hiyd_cms/file/e310a2fa0cfe4150b0ed34047998b7f2.mp4"]];
	self.player.title = @"123";
